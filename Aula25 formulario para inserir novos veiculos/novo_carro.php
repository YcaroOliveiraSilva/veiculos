	...
	<body>
		...
		<section id="main">
         ...
         ?>
			...
			<form name="f_novo_carro" action="novo_carro.php" class="f_novocarro" method="get" enctype="">
               ...
               <select name="f_modelo">
                 ...
                 <input type="file" name="f_foto2">
                        <label>Opcionais</label>
                         <div>
                         	<input type="checkbox" name="f_opc1" value="1"><label>OPC 1</label>
                         	<input type="checkbox" name="f_opc2" value="1"><label>OPC 2</label>
                         	<input type="checkbox" name="f_opc3" value="1"><label>OPC 3</label>
                         </div>
